...
public class CircleAnimationUtil {
    ...
    private int mBorderColor = Color.parseColor("#e06a4e");
    ...
    private AnimatorSet getAvatarRevealAnimator() {
        ...
        Animator mRevealAnimator = ObjectAnimator.ofFloat(mImageView,
                "drawableRadius", startRadius,
                endRadius * 1.05f, endRadius * 0.9f, endRadius);
...
//        float scaleFactor = Math.max(2f * destY / originY, 2f * destX / originX);
        ...
        Animator scaleAnimatorY = ObjectAnimator.ofFloat(mImageView,
                View.SCALE_Y, 1, 1, scaleFactor, scaleFactor);
        Animator scaleAnimatorX = ObjectAnimator.ofFloat(mImageView,
                View.SCALE_X, 1, 1, scaleFactor, scaleFactor);
